...
def main():
    ...
    experiment_folder = f"/{root_exp_dir}/{user}/{git_branch}_expr_score"
    training_experiment = f"/{root_exp_dir}/{user}/{git_branch}_expr"
    ...
    mlflow.run(
        "projects/ExampleScoringProject",
        backend="databricks",
        backend_config="projects/ExampleScoringProject/cluster.json",
        parameters={"training_experiment":training_experiment, "model_name":model_name})
